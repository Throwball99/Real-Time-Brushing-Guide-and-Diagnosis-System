...
class PortableTopToothShape extends HookWidget {
  final int selectedNumber;
  final List<int> timeList;


  const PortableTopToothShape({Key? key, required this.selectedNumber, required this.timeList}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(
      size: Size(350, 120),
      painter: PortableTopToothShapePainter(
...
class PortableTopToothShapePainter extends CustomPainter {
  final double animation;
  final int selectedNumber;
  final List<int> timeList;
  final List<bool> isAnimating;

  PortableTopToothShapePainter({required this.selectedNumber, required this.timeList, required this.animation, required this.isAnimating});
...
class PortableDownToothShape extends HookWidget {
  final int selectedNumber;
  final List<int> timeList;

  const PortableDownToothShape({Key? key, required this.selectedNumber, required this.timeList}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(
      size: Size(350, 120),
      painter: PortableDownToothShapePainter(
        animation: blurAnimation,
        selectedNumber: selectedNumber,
        timeList: timeList,
      ),
...
class PortableDownToothShapePainter extends CustomPainter {
  final int selectedNumber;
  final List<int> timeList;
  final double animation;

  PortableDownToothShapePainter({required this.selectedNumber, required this.timeList, required this.animation});
